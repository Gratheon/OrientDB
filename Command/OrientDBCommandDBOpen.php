...
class OrientDBCommandDBOpen extends OrientDBCommandAbstract
{
    ...
    public function prepare()
    {
        ...
        if (count($this->attribs) != 3) {
            throw new \Gratheon\OrientDB\OrientDBWrongParamsException('This command requires DB name, login and password');
        }
        // Add Driver name
        $this->addString(\Gratheon\OrientDB\OrientDB::DRIVER_NAME);
        // Add Driver version
        $this->addString(\Gratheon\OrientDB\OrientDB::DRIVER_VERSION);
