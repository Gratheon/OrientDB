...
class OrientDBCommandRecordLoad extends OrientDBCommandAbstract
{
    ...
    public function prepare()
    {
        ...
        if (count($this->attribs) > 2 || count($this->attribs) < 1) {
            throw new \Gratheon\OrientDB\OrientDBWrongParamsException('This command requires record ID and, optionally, fetch plan');
        }
     ...
     * @return bool|\Gratheon\OrientDB\OrientDBTypeLink|\Gratheon\OrientDB\OrientDBRecord
     */
