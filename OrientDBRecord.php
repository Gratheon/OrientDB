...
class OrientDBRecord
{
    ...
    /**
     * Document type
     * @example \Gratheon\OrientDB\OrientDB::RECORD_TYPE_DOCUMENT
     * @see \Gratheon\OrientDB\OrientDB::$recordTypes
     * @var string
     */
    public $type = \Gratheon\OrientDB\OrientDB::RECORD_TYPE_DOCUMENT;
    ...
    public function parse()
    {
        ...
        if (!$this->isParsed) {
            ...
            if ($this->type == \Gratheon\OrientDB\OrientDB::RECORD_TYPE_DOCUMENT) {
